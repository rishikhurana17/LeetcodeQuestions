...
public class WordLadderII {
    ...
    public List<List<String>> findLaddersBidirectional(String beginWord,
        ...
        List<String> list = new ArrayList<>();
        list.add(beginWord);
        dfs2(res, list, beginWord, endWord, map);
        return res;
    }


    private void dfs2(List<List<String>> res, List<String> list,
