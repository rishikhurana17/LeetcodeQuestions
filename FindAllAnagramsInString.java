...
public class FindAllAnagramsInString {
    ...
    public List<Integer> findAllAnagrams(String s, String p) {
        ...
        char temp;
        //Before we begin this, the "window" has a length of 0, start and end pointers both at 0
        for (end = 0; end < len; end++){
            ...
            //If it's still >= 0, the anagram still "needed" it so we count it towards the anagram by decrementing diff
            if (chars[temp-'a'] >= 0){
                diff--;
            }
        }
